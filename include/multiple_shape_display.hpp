 ...
 * in RVIZ setting.
 */
class MultipleShapeDisplay final : public rclcpp::Node,
 ...
 public:
   ...
   */
  explicit MultipleShapeDisplay(
      std::string const& node_name, std::chrono::milliseconds refresh_period,
 ...
 private:
  ...
  std::shared_ptr<shapes::DisplayableInterface> object_to_display_;
